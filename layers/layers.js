...
var format_HyperspectralExperimentAreas_7 = new ol.format.GeoJSON();
var features_HyperspectralExperimentAreas_7 = format_HyperspectralExperimentAreas_7.readFeatures(json_HyperspectralExperimentAreas_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_HyperspectralExperimentAreas_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_HyperspectralExperimentAreas_7.addFeatures(features_HyperspectralExperimentAreas_7);
var lyr_HyperspectralExperimentAreas_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_HyperspectralExperimentAreas_7, 
                style: style_HyperspectralExperimentAreas_7,
                popuplayertitle: "Hyperspectral Experiment Areas",
                interactive: true,
                title: '<img src="styles/legend/HyperspectralExperimentAreas_7.png" /> Hyperspectral Experiment Areas'
            });
var format_HyperspectralExperimentPoints_8 = new ol.format.GeoJSON();
var features_HyperspectralExperimentPoints_8 = format_HyperspectralExperimentPoints_8.readFeatures(json_HyperspectralExperimentPoints_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_HyperspectralExperimentPoints_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_HyperspectralExperimentPoints_8.addFeatures(features_HyperspectralExperimentPoints_8);
var lyr_HyperspectralExperimentPoints_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_HyperspectralExperimentPoints_8, 
                style: style_HyperspectralExperimentPoints_8,
                popuplayertitle: "Hyperspectral Experiment Points",
                interactive: true,
                title: '<img src="styles/legend/HyperspectralExperimentPoints_8.png" /> Hyperspectral Experiment Points'
            });

lyr_GoogleSatelliteMap_0.setVisible(true);lyr_KSM_GISKSM_Basin_1.setVisible(true);lyr_KSM_GISReservoir_KSM_2.setVisible(true);lyr_KSM_GISKSM_Main_river_3.setVisible(true);lyr_KSM_GISKSM_River2_4.setVisible(true);lyr_KSM_GISRIDKU_WaterLevel_5.setVisible(true);lyr_KSM_GISWeir_KSM_6.setVisible(true);lyr_HyperspectralExperimentAreas_7.setVisible(true);lyr_HyperspectralExperimentPoints_8.setVisible(true);
var layersList = [lyr_GoogleSatelliteMap_0,lyr_KSM_GISKSM_Basin_1,lyr_KSM_GISReservoir_KSM_2,lyr_KSM_GISKSM_Main_river_3,lyr_KSM_GISKSM_River2_4,lyr_KSM_GISRIDKU_WaterLevel_5,lyr_KSM_GISWeir_KSM_6,lyr_HyperspectralExperimentAreas_7,lyr_HyperspectralExperimentPoints_8];
...
lyr_HyperspectralExperimentAreas_7.set('fieldAliases', {'Name': 'Name', 'description': 'description', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMode': 'altitudeMode', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', });
lyr_HyperspectralExperimentPoints_8.set('fieldAliases', {'Name': 'Name', 'description': 'description', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMode': 'altitudeMode', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', });
...
lyr_HyperspectralExperimentAreas_7.set('fieldImages', {'Name': 'TextEdit', 'description': 'TextEdit', 'timestamp': 'DateTime', 'begin': 'DateTime', 'end': 'DateTime', 'altitudeMode': 'TextEdit', 'tessellate': 'Range', 'extrude': 'Range', 'visibility': 'Range', 'drawOrder': 'Range', 'icon': 'TextEdit', });
lyr_HyperspectralExperimentPoints_8.set('fieldImages', {'Name': 'TextEdit', 'description': 'TextEdit', 'timestamp': 'DateTime', 'begin': 'DateTime', 'end': 'DateTime', 'altitudeMode': 'TextEdit', 'tessellate': 'Range', 'extrude': 'Range', 'visibility': 'Range', 'drawOrder': 'Range', 'icon': 'TextEdit', });
...
lyr_KSM_GISWeir_KSM_6.set('fieldLabels', {'fid': 'no label', 'FID_โครงกา': 'no label', 'ลำดับที่': 'no label', 'โครงการ': 'no label', 'รหัสลุ่มน้': 'no label', 'ตำบล': 'no label', 'อำเภอ': 'no label', 'จังหวัด': 'no label', 'ละติจูด': 'no label', 'ลองติจูด': 'no label', 'ลุ่มน้ำหลั': 'no label', 'ลุ่มน้ำรอง': 'no label', 'ลักษณะอาคา': 'no label', 'ลักษณะโครง': 'no label', 'ปริมาณน้ำเ': 'no label', 'MODEL__Yes': 'no label', 'พื้นที่โคร': 'no label', 'พื้นที่ชลป': 'no label', 'พื้นที่ช_1': 'no label', 'พื้นที่รับ': 'no label', 'ปีที่เริ่ม': 'no label', 'ปีที่สร้าง': 'no label', 'พระราชดำริ': 'no label', 'หมายเหตุ': 'no label', 'หน่วยงาน_ร': 'no label', 'F24': 'no label', 'F25': 'no label', 'F26': 'no label', 'F27': 'no label', 'F28': 'no label', 'FID_SubBas': 'no label', 'OBJECTID': 'no label', 'SB_CODE': 'no label', 'SB_NAME_T': 'no label', 'MB_CODE': 'no label', 'MBASIN_T': 'no label', 'SB_SQKM': 'no label', 'Shape_Leng': 'no label', 'Shape_Area': 'no label', 'X': 'no label', 'Y': 'no label', 'Name': 'inline label - always visible', });
lyr_HyperspectralExperimentAreas_7.set('fieldLabels', {'Name': 'inline label - always visible', 'description': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMode': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', });
lyr_HyperspectralExperimentPoints_8.set('fieldLabels', {'Name': 'inline label - always visible', 'description': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMode': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', });
lyr_HyperspectralExperimentPoints_8.on('precompose', function(evt) {
